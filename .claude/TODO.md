...
- [ ] add a lint check in package.js which forbids use of console printing outside of secure logging module
- [ ] expo blur is not working at runtime on testing devices. I likely needs to be added to a Context used in _layout.tsx
