...
- [ ] Added FLAG_SECURE to expo compile time, not in ephemeral ./android folder
- [ ] Why not add screen capture protection to the outermost component of the app, instead of on each route?  Also disable screen shots completely at the build level. Add this to spec documentation.
