import { clearAllSecureStorage, getValue, getAllKeys } from "./secure-store";
import { verifyStoredPin } from "./pin-security";
...
export async function clearAllStorage(): Promise<void> {
  try {
    ...
    console.error("Error clearing all data:",
 ...
 */
export async function clearAllWithPinVerification(pin: string): Promise<void> {
