...
export const useRecoveryState = () => {
  ...
  const actions: RecoveryActions = {
    ...
    setIsVerifiedMnemonic: (isVerifiedMnemonic: boolean) => setState(prev => ({ ...prev, isVerifiedMnemonic })),
    setDerivedAddress: (derivedAddress: AccountAddress | null) => setState(prev => ({ ...prev, derivedAddress })),
    setIsChainVerified: (isChainVerified: boolean) => setState(prev => ({ ...prev, isChainVerified })),
    setChainAddress: (chainAddress: AccountAddress | null) => setState(prev => ({ ...prev, chainAddress })),
    setIsVerifyingChain: (isVerifyingChain: boolean) => setState(prev => ({ ...prev, isVerifyingChain })),
    setIsDeriving: (isDeriving: boolean) => setState(prev => ({ ...prev, isDeriving })),
